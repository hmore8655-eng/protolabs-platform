...
const db = require('./db');
const { loginUser, verifyToken } = require('./services/auth');
const { sendInquiryConfirmation, sendQuoteProposalEmail } = require('./services/email');
...
app.post('/api/auth/login', (req, res) => {
  ...
  // Allow login by email or default admin password shortcut
...
// Projects API (Public GET, Protected POST/PUT/DELETE)
...
// Inquiries API (Public POST, Protected GET/PUT/DELETE)
...
app.listen(PORT, () => {
  console.log(`=======================================================`);
  console.log(`🚀 ProtoLabs Full-Stack Backend Server Active!`);
